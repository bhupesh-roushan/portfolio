  ...
  return (
    <section className="flex justify-center min-h-screen flex-wrap items-center">
      ...
      >
        ...
        <p className="mb-8 p-1 text-xl text-justify font-normal">
          {HERO.description1}
        </p>
        <p className="mb-8 p-1 text-xl text-justify font-normal">
          {HERO.description2}
      ...
      >
        <div className="flex flex-col justify-between items-center">
          ...
          >
            <button className="mt-20 bg-white text-black p-2 rounded-lg shadow-md border hover:scale-105 transition-transform delay-120 ease-in-out shadow-blue-900 duration-500">
              Download Resume
            </button>
          </a>
        </div>
